...
@javax.annotation.Generated(
    ...
    comments = "Source: grpc-example.proto")
public class HelloGrpc {

  private HelloGrpc() {}

  public static final String SERVICE_NAME = "clojure_grpc_example.Hello";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<clojuregrpcexample.grpc.GrpcExample.Person,
      clojuregrpcexample.grpc.GrpcExample.Answer> METHOD_SAY_HELLO =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "clojure_grpc_example.Hello", "SayHello"),
          io.grpc.protobuf.ProtoUtils.marshaller(clojuregrpcexample.grpc.GrpcExample.Person.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(clojuregrpcexample.grpc.GrpcExample.Answer.getDefaultInstance()));
  ...
  public static abstract class HelloImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(clojuregrpcexample.grpc.GrpcExample.Person request,
        io.grpc.stub.StreamObserver<clojuregrpcexample.grpc.GrpcExample.Answer> responseObserver) {
    ...
    @java.lang.Override public io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                clojuregrpcexample.grpc.GrpcExample.Person,
                clojuregrpcexample.grpc.GrpcExample.Answer>(
  ...
  public static final class HelloBlockingStub extends io.grpc.stub.AbstractStub<HelloBlockingStub> {
    ...
    /**
     */
    public clojuregrpcexample.grpc.GrpcExample.Answer sayHello(clojuregrpcexample.grpc.GrpcExample.Person request) {
  ...
  public static final class HelloFutureStub extends io.grpc.stub.AbstractStub<HelloFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<clojuregrpcexample.grpc.GrpcExample.Answer> sayHello(
        clojuregrpcexample.grpc.GrpcExample.Person request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((clojuregrpcexample.grpc.GrpcExample.Person) request,
              (io.grpc.stub.StreamObserver<clojuregrpcexample.grpc.GrpcExample.Answer>) responseObserver);
          break;
        default:
